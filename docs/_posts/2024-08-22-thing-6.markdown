...
The Github repo for this thing can be found [here](https://github.com/jasper9/thing6-cloudformation-static-web-s3)
...
The exact yaml file can be found in my repo [here](https://github.com/jasper9/thing6-cloudformation-static-web-s3/blob/main/s3_website_cloudformation.yaml)
