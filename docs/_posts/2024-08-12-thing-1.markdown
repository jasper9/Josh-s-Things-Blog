...
categories: things web publicCloud aws s3
---
...
I have this domain registered in the very awesome service [Porkbun](https://porkbun.com/), not in Route 53 (AWS' DNS service) so I need to make some adjustments. This would be the same if yours is in GoDaddy, Name.com or anywhere else. Alternatively you could transfer the domain from your current servce *into* Route 53 but that takes more time and I want it done noooow.  
